...
//ADMIN Get all products from /api/v1/admin/products
...
exports.updateProduct = catchAsyncErrors(async (req, res, next) => {
  ...
  if (images !== undefined) {
    // Updating images associated with the product
...
//ADMIN Get product reviews -> /api/v1/admin/reviews
